class OrderShipping
  ...
  with_options presence: true do
    ...
    validates :phone_number, length: { in: 10..11, message: 'is invalid. Enter in 10 to 11 digits' }, numericality: { only_integer: true, message: 'is invalid. Input only number' }
  end
